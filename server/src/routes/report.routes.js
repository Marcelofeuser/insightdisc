...
function normalizeReportType(value) {
  return normalizeCanonicalReportType(value, 'business');
}
...
router.get(
  ...
  async (_req, res) => {
    return res.status(410).json({
      ...
      message:
        'O download por assessmentId foi desativado. Use /assessment/public-token/:id para emitir um token e baixe via /api/report/pdf?token=....',
    });
  },
);
