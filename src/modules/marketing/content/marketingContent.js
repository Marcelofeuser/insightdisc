...
export const MAIN_LANDING_CONTENT = Object.freeze({
  ...
  hero: {
    ...
    compatibilityCta: { label: 'Fazer Teste Grátis', to: '/planos' },
    quickActions: [
  ...
  comparison: {
  title: 'Comparativo completo: recursos, escala e diferenciais',
  rows: [
    {
      metric: 'Avaliação individual',
      disc: '✓',
      personal: '✓',
      insider: '✓',
      professional: '✓',
    ...
    {
      metric: 'Uso com IA (insights e recomendações)',
      disc: '—',
      personal: '—',
      insider: '✓',
      professional: '✓',
    ...
    {
      metric: 'Comparação inteligente de perfis',
      disc: '—',
      personal: '—',
      insider: '✓',
      professional: '✓',
    ...
    {
      metric: 'Direcionamentos de desenvolvimento',
      disc: '—',
      personal: '✓',
      insider: '✓',
      professional: '✓',
    ...
    {
      metric: 'Dossiê comportamental completo',
      disc: '—',
      personal: '—',
      insider: '—',
      professional: '✓',
    ...
    {
      metric: 'Análise de perfis em grupo',
      disc: '—',
      personal: '—',
      insider: '—',
      professional: '—',
    ...
    {
      metric: 'Comparação entre colaboradores',
      disc: '—',
      personal: '—',
      insider: '—',
      professional: '—',
    ...
    {
      metric: 'Apoio à liderança e decisão',
      disc: '—',
      personal: '—',
      insider: '—',
      professional: '—',
    ...
    {
      metric: 'Gestão de múltiplos usuários',
      disc: '—',
      personal: '—',
      insider: '—',
      professional: '—',
    ...
    {
      metric: 'Acompanhamento especializado',
      disc: '—',
      personal: '—',
      insider: '—',
      professional: '—',
  ...
  finalCta: {
    ...
    primary: { label: 'Criar conta grátis', to: '/planos' },
