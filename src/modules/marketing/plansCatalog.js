export const PLANS = Object.freeze({
  ...
  profissional: {
    ...
    benefits: [
      'Tudo do Personal',
      '10 créditos por mês',
      'Envio de avaliações DISC',
      'Gestão de avaliações realizadas',
      'Comparação de perfis comportamentais',
      'Dossiê comportamental completo',
      'Relatórios técnicos avançados',
      'Biblioteca DISC (conteúdo em expansão)',
      'Arquétipos comportamentais (novas funcionalidades sendo adicionadas continuamente)',
      'Coach DISC com recomendações práticas',
      'Acesso ao AI Lab (preview de IA)',
    ],
  ...
  business: {
    ...
    benefits: [
      ...
      '25 créditos por mês',
      'Team Map (visual de equipe)',
      'Análise de perfis em grupo',
      'Comparação entre colaboradores',
      'Apoio à liderança e tomada de decisão',
      'Gestão de múltiplos usuários',
      'Aplicação DISC em equipes e empresas',
    ],
