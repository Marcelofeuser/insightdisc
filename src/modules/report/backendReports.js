...
export function mapCandidateReportItem(item = {}, index = 0) {
  ...
  const mapped = {
    ...
    status: 'completed',
    type: item?.reportType || item?.type || 'business',
    report_type: item?.reportType || item?.type || 'business',
    reportType: item?.reportType || item?.type || 'business',
    pdfUrl: item?.publicPdfUrl || item?.pdfUrl || '',
    pdf_url: item?.publicPdfUrl || item?.pdfUrl || '',
    publicToken: item?.publicToken || '',
    public_token: item?.publicToken || '',
    publicReportUrl: item?.publicReportUrl || '',
    public_report_url: item?.publicReportUrl || '',
    publicPdfUrl: item?.publicPdfUrl || '',
    public_pdf_url: item?.publicPdfUrl || '',
