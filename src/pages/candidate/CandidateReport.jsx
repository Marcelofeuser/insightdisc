...
function normalizeAssessmentFromApi(assessment, discProfile) {
...
export default function CandidateReport() {
    ...
    const loadReport = async () => {
      ...
      try {
        if (apiBaseUrl && token) {
          ...
          const normalizedAssessment = normalizeAssessmentFromApi(payload?.assessment, payload?.report?.discProfile);
          if (
  ...
  const reportModel = useMemo(
    () => (assessment ? buildDiscReportModel(assessment) : null),
    [assessment]
  );
