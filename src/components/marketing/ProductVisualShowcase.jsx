      ...
      <div className="max-w-7xl mx-auto">
        ...
        {variant === 'personal' ? (
          <div className="grid xl:grid-cols-2 gap-6">
            <DiscRadar title={content.radar.title} subtitle={content.radar.subtitle} values={content.radar.values} />
            <div className="grid gap-6">
              <InsightCards cards={content.insights} />
              <ReportPreview title={content.preview.title} badge={content.preview.badge} lines={content.preview.lines} />
            </div>
          </div>
        ) : null}
        ...
        {variant === 'profissional' ? (
          <div className="grid xl:grid-cols-2 gap-6">
            <div className="grid gap-6">
              <DiscRadar title={content.radar.title} subtitle={content.radar.subtitle} values={content.radar.values} />
              <DiscBars title={content.bars.title} values={content.bars.values} />
            </div>
            <div className="grid gap-6">
              <TechnicalReadBlock title={content.technical.title} bullets={content.technical.bullets} />
              <ReportPreview title={content.preview.title} badge={content.preview.badge} lines={content.preview.lines} />
            </div>
          </div>
        ) : null}
        ...
        {variant === 'business' ? (
          <div className="grid gap-6">
            <div className="grid xl:grid-cols-2 gap-6">
              <TeamMapCard title={content.teamMap.title} members={content.teamMap.members} />
              <DiscBars title={content.bars.title} values={content.bars.values} />
            </div>
            <div className="grid xl:grid-cols-2 gap-6">
              <DiscRadar title={content.radar.title} subtitle={content.radar.subtitle} values={content.radar.values} />
        ...
        {variant === 'dossie' ? (
          <div className="grid gap-6">
            <div className="grid xl:grid-cols-2 gap-6">
              <DiscRadar title={content.radar.title} subtitle={content.radar.subtitle} values={content.radar.values} />
              <TechnicalReadBlock title={content.reportStructure.title} bullets={content.reportStructure.bullets} />
            </div>
            <FlowPipeline title={content.flow.title} stages={content.flow.stages} />
          </div>
        ) : null}
      </div>
    </section>
